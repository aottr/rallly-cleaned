    ...
    <div className="mx-auto max-w-7xl items-end p-8 lg:flex lg:justify-between">
      <div className="my-8 text-center lg:text-left">
        ...
        <div className="space-x-3">
          <a
            href="/new"
            className="rounded-lg bg-primary-500 px-6 py-4 font-semibold text-white shadow-sm  transition-all hover:bg-primary-500/90 hover:text-white hover:no-underline hover:shadow-md focus:ring-2  focus:ring-primary-200 active:bg-primary-600/90"
          >
            {t("getStarted")}
          </a>
        </div>
